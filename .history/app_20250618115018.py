...
1. Interview Summary
2. Key Strengths (table)
3. Areas for Improvement (table)
4. Visual Analysis (skill distribution)
...
def process_answer():
    ...
    interview_data['conversation_history'][-1]['feedback_label'] = feedback_label
    feedback_audio = text_to_speech(feedback_label)
    interview_data['conversation_history'][-1]['feedback_audio'] = feedback_audio
    visual_feedback = None
    current_time = datetime.now().timestamp()
